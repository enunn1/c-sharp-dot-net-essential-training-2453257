...
//     {
//         Console.WriteLine();
//         break; // exit the loop when we hit 'b'
//     }
// }
// TODO: String Concatenation         
// string outstr;
// outstr = String.Concat(strs); // Concatenates all strings in the array
// Console.WriteLine(outstr);

// TODO: Joining strings together with Join
// outstr = String.Join('.', strs); // Joins all strings in the array with a period separator
// Console.WriteLine(outstr);

// outstr = String.Join("---", strs); // Joins all strings in the array with a dash separator
// Console.WriteLine(outstr);
